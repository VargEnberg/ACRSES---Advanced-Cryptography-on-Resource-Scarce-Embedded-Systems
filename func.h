...
uint8_t const_Rb[BLOCK_SIZE] = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x87 };
uint8_t const_Zero[BLOCK_SIZE] = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
static void padding(uint8_t *lastb, uint8_t *pad, int length) {
	int j;
...
static void generate_subkey(uint8_t *key, uint8_t *K1, unsigned
char *K2) {
	uint8_t L[BLOCK_SIZE] = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };
	uint8_t tmp[BLOCK_SIZE];

	
	struct AES_ctx subkey;
	AES_init_ctx(&subkey, key);
	AES_ECB_encrypt(&subkey, L);
...
void AES_CMAC(uint8_t*key, uint8_t *input, int length,
		uint8_t *mac) {
...
int AES_CMAC_CHECK(uint8_t *key, uint8_t *input, int length, uint8_t *mac){
